...
HMDT::GUI::ProvincePreviewDrawingArea::ProvincePreviewDrawingArea():
    m_data()
{ }
...
bool HMDT::GUI::ProvincePreviewDrawingArea::isValid() const {
    return m_data.expired();
}

bool HMDT::GUI::ProvincePreviewDrawingArea::on_draw(const Cairo::RefPtr<Cairo::Context>& cr)
{
...
Gtk::Widget* HMDT::GUI::ProvincePreviewDrawingArea::getParent() {
    return get_parent();
}
