...
MapNormalizer::GUI::StatePropertiesPane::ProvinceRow::ProvinceRow(Gtk::ListBox* owning_box,
                                                                  ProvinceID id):
    m_province_id(id),
    ...
    m_remove_button("×")
{
    ...
    m_remove_button.signal_clicked().connect([this]() {
        if(auto opt_project = Driver::getInstance().getProject(); opt_project) {
            ...
            if(map_project.isValidProvinceLabel(m_province_id)) {
                auto& province = map_project.getProvinceForLabel(m_province_id);
...
auto MapNormalizer::GUI::StatePropertiesPane::ProvinceRow::getProvinceID() const
    -> ProvinceID
{
...
void MapNormalizer::GUI::StatePropertiesPane::buildSelectAllProvincesButton() {
...
void MapNormalizer::GUI::StatePropertiesPane::buildDeleteStateButton() {
...
void MapNormalizer::GUI::StatePropertiesPane::updateProperties(bool is_multiselect)
{
