...
MapNormalizer::GUI::IProvincePreviewDrawingAreaBase::IProvincePreviewDrawingAreaBase():
    m_scalex(1),
    m_scaley(1),
    m_width(0),
    m_height(0)
...
void MapNormalizer::GUI::IProvincePreviewDrawingAreaBase::setScale(double x,
                                                                   double y)
{
    m_scalex = x;
    m_scaley = y;
...
std::pair<double, double> MapNormalizer::GUI::IProvincePreviewDrawingAreaBase::getScale() const
{
    return std::make_pair(m_scalex, m_scaley);
}

void MapNormalizer::GUI::IProvincePreviewDrawingAreaBase::setDimensions(uint32_t width,
                                                                        uint32_t height)
{
    m_width = width;
    m_height = height;
...
std::pair<uint32_t, uint32_t> MapNormalizer::GUI::IProvincePreviewDrawingAreaBase::getDimensions() const
{
 ...
 */
void MapNormalizer::GUI::IProvincePreviewDrawingAreaBase::calcScale() {
