...
auto MapNormalizer::GUI::MainWindowPropertiesPanePart::getProvincePropertiesPane()
    -> ProvincePropertiesPane&
{
    return *m_province_properties_pane;
}

auto MapNormalizer::GUI::MainWindowPropertiesPanePart::getStatePropertiesPane()
    -> StatePropertiesPane&
{
    return *m_state_properties_pane;
}

auto MapNormalizer::GUI::MainWindowPropertiesPanePart::getProvincePropertiesPane() const
    -> const ProvincePropertiesPane&
{
    return *m_province_properties_pane;
}

auto MapNormalizer::GUI::MainWindowPropertiesPanePart::getStatePropertiesPane() const
 ...
 */
Gtk::Frame* MapNormalizer::GUI::MainWindowPropertiesPanePart::buildPropertiesPane(Gtk::Paned* pane)
{
